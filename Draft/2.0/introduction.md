...
2. **A curvature-adaptive dual-gate freeze policy.** A freeze test combining displacement stability and KNN topology stability with curvature-scaled streak requirements, reducing false-freeze rates from 64\% to below 2\% while progressively freezing 80–98\% of sites.
